...
@Component({
  selector: 'app-chart2-all-shelf-all-hall',
  templateUrl: './chart2-all-shelf-all-hall.component.html',
  styleUrls: ['./chart2-all-shelf-all-hall.component.scss']
})
export class Chart2AllShelfAllHallComponent implements OnInit {
